...
public class FuncionarioController(ServicoFuncionario servicoFuncionario, IMapper mapeador) : Controller
{
    ...
    {
        Result<ListarFuncionariosDto> resultado = servicoFuncionario.SelecionarPorId(id);
        ...
        EditarFuncionarioViewModel editarVm =
            mapeador.Map<EditarFuncionarioViewModel>(resultado.Value);
